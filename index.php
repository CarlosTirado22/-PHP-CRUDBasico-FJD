            ...
            <table id="tabla">
                <thead>
                    <tr>
                        ...
                        <th> Departamento <span class="icon-arrow">&UpArrow;</span></th>
            ...
            <div class="modal-content ">
                ...
                <form method="POST" id="formulario" action="php/funciones.php">
                    <div class="modal-body">
                        ...
                        <select name="pais" id="pais" class="form-control inputform" require> </select>
                        <br>

                        <label for="departamento">Ingrese su departamento de origen</label>
                        <select name="departamento" id="departamento" class="form-control inputform" require> </select>
                        <br>

                        <label for="ciudad">Ingrese su ciudad de origen</label>
                        <select name="ciudad" id="ciudad" class="form-control inputform" require> </select>
                        <br>
